// Shared by the operations dashboard and the Node email generator.
...
function buildShipmentSummary({ items, events, now, snapGroupId, fieldServiceGroupId }) {
    ...
    return { today, end, records, snap: summarize('snap'), fieldService: summarize('fieldService'), total: summarize(null),
