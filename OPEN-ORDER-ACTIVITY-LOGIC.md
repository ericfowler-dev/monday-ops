...
| Where work is stuck | Compact two-column stacked bar chart for the top 6 statuses by waiting count. Each half-width card shows population, waiting/current counts, waiting percentage, and oldest order age, and links to Ambrea's live Monday overview. Red bar segments are waiting >24h; pale segments are the balance of current work. |
